...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['COMPUTER_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['COMPUTER_LOG'] or 'warn' if it isn't set.
   */
...
export class Computer {
   ...
   * @param {string} [opts.baseURL=process.env['COMPUTER_BASE_URL'] ?? //localhost:8080/v1] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `//localhost:8080/v1`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Computer.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('COMPUTER_LOG'), "process.env['COMPUTER_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== '//localhost:8080/v1';
  }
  ...
  static Computer = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static ComputerError = Errors.ComputerError;
