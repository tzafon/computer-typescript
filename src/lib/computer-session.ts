...
export class ComputerSession {
   ...
   */
  async setViewport(width: number, height: number, scale_factor?: number): Promise<Computers.ActionResult> {
   ...
   */
  async batch(
    actions: Computers.ComputerExecuteBatchParams['actions'],
  ): Promise<Computers.ComputerExecuteBatchResponse> {
