...
describe('resource computers', () => {
  ...
  // Prism tests are disabled
  test.skip('connectWebsocket', async () => {
    const responsePromise = client.computers.connectWebsocket('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('getHTML', async () => {
    const responsePromise = client.computers.getHTML('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('scrollViewport', async () => {
    const responsePromise = client.computers.scrollViewport('id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('setViewport', async () => {
    const responsePromise = client.computers.setViewport('id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('streamScreencast', async () => {
    const responsePromise = client.computers.streamScreencast('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Prism tests are disabled
  test.skip('typeText', async () => {
    const responsePromise = client.computers.typeText('id', {});
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
