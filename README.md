...
[![NPM version](<https://img.shields.io/npm/v/computer.svg?label=npm%20(stable)>)](https://npmjs.org/package/computer) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/computer)
...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install computer`
...
```ts
import Computer from 'npm:computer';
