...
- <code><a href="./src/resources/computers/exec.ts">ExecExecuteResponse</a></code>
- <code><a href="./src/resources/computers/exec.ts">ExecExecuteSyncResponse</a></code>

Methods:

- <code title="post /computers/{id}/exec">client.computers.exec.<a href="./src/resources/computers/exec.ts">execute</a>(id, { ...params }) -> ExecExecuteResponse</code>
- <code title="post /computers/{id}/exec/sync">client.computers.exec.<a href="./src/resources/computers/exec.ts">executeSync</a>(id, { ...params }) -> ExecExecuteSyncResponse</code>
